...
import static Velo.FXML_ProductController.Idstat;
...
FileInputStream input = null;
              try {
                  input = new FileInputStream("C:\\Users\\user\\Desktop\\PIFX4\\src\\image\\"+lst.getPhoto());
...
comment = comment.replaceAll("\\b"+s+"\\b", etoiless);
           ...
           if(conUser.getUser().equals(cs.Finduser(ct.getUserid()))){
